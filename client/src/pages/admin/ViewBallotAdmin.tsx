			...
			<PageHeader
				...
				action={
					<Stack direction="row" spacing={2} alignItems="center">
						{user?.id === ballot.adminId &&
							ballot.status.toLowerCase() === "active" && (
								<>
									<Button
										variant="outlined"
										color="warning"
										...
										onClick={() => handleBallotAction("suspend")}
										...
										<Card elevation={2} sx={{ height: "100%" }}>
											...
											>
												...
												<Typography
													...
													sx={{ mt: 1 }}
												>
													{analytics.totalVotes} of {analytics.eligibleUsers}{" "}
													users
												</Typography>
											</CardContent>
										</Card>
